...
public class FormDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FormDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExpAccess().getTextAssignment_0_0(), "rule__Exp__TextAssignment_0_0");
			builder.put(grammarAccess.getExpAccess().getTextAssignment_0_1(), "rule__Exp__TextAssignment_0_1");
